...
public class Facility extends JFrame implements ActionListener, MouseListener,IFacility {
	...
	public Facility (SecondPage sp)
	{
		...
		faciLabel = new JLabel(" Facility Section");
		faciLabel.setBounds(30, 30, 200, 50);
		faciLabel.setForeground(Color.BLUE);
		faciLabel.setFont(myFont1);
	...
	{    
		for(int i=0;i<account.length;i++)
		{
		  if (account[i]!=null)
		   { 
			JOptionPane.showMessageDialog(null,i+1+" .Facility Name: "+account[i].getName());
