...
public class Lab extends JFrame implements ActionListener, MouseListener,ILab {
	...
	public Lab (SecondPage sp)
	{
		...
		labLabel.setBounds(30, 30, 200, 50);
		labLabel.setForeground(Color.GREEN);
		labLabel.setFont(myFont1);
	...
	{   
		for(int i=0;i<account.length;i++)
		{
		  if (account[i]!=null)
		   { 
			JOptionPane.showMessageDialog(null,i+1+" .Lab Name: "+account[i].getName());
