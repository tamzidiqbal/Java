...
public class Doctor extends JFrame implements ActionListener, MouseListener,IDoctor {
	...
	{    
		for(int i=0;i<account.length;i++)
		{
		  if (account[i]!=null)
		   { 
			JOptionPane.showMessageDialog(null,i+1+" .Doctor Name: "+account[i].getName());
